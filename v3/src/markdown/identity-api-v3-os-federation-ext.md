...
Coinciding with Identity API v3.3 release. These features are not yet
...
**Deprecated in v1.1**. Use `GET /auth/projects`. This call has the same
response format.
...
**Deprecated in v1.1**. Use `GET /auth/domains`. This call has the same
response format.
