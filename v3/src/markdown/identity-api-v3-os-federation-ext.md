...
Relationship: `http://docs.openstack.org/identity/rel/v3/ext/OS-FEDERATION/1.0/identity_provider`
...
Relationship: `http://docs.openstack.org/identity/rel/v3/ext/OS-FEDERATION/1.0/identity_providers`
...
Relationship: `http://docs.openstack.org/identity/rel/v3/ext/OS-FEDERATION/1.0/identity_provider_protocol`
...
Relationship: `http://docs.openstack.org/identity/rel/v3/ext/OS-FEDERATION/1.0/identity_provider_protocols`
...
Relationship: `http://docs.openstack.org/identity/rel/v3/ext/OS-FEDERATION/1.0/mapping`
...
Relationship: `http://docs.openstack.org/identity/rel/v3/ext/OS-FEDERATION/1.0/mappings`
...
Relationship: `http://docs.openstack.org/identity/rel/v3/ext/OS-FEDERATION/1.0/projects`
...
Relationship: `http://docs.openstack.org/identity/rel/v3/ext/OS-FEDERATION/1.0/domains`
...
Relationship: `http://docs.openstack.org/identity/rel/v3/ext/OS-FEDERATION/1.0/identity_provider_protocol_auth`
