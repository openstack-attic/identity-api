...
characteristics, such as service, type, region. Indeed, any endpoint attribute
could be used as part of a filter. A classic use case is to filter endpoints
based on region. For example, suppose I want to filter service endpoints
returned in the service catalog by region:
