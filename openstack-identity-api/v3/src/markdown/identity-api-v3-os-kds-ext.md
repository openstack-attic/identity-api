...
#### Ticket Request: `POST /OS-KDS/ticket`
...
Serialized JSON array including the following attributes:
 ...
 - `timestamp` - UTC time in the epoch form "%s.%f" seconds.microseconds
...
Serialized JSON array including the following attributes:
 ...
 - `expiration` - UTC time in the epoch form "%s.%f" seconds.microseconds
...
array containing the following attributes:
 ...
 - `timestamp`: UTC time in the epoch form "%s.%f" seconds.microseconds of when the key was generated.
...
#### Group Key Request: `POST /OS-KDS/group_key`
...
#### Set Key Request: `PUT /OS-KDS/keys/{name}`
...
#### Remove Key Request: `DELETE /OS-KDS/keys/{name}`
...
#### Create Group Request: `PUT /OS-KDS/groups/{name}`
...
#### Remove Group Request: `DELETE /OS-KDS/groups/{name}`
