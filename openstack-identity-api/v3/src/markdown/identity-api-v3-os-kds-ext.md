...
Serialized JSON array including the following attributes:
 ...
 - `timestamp` - ISO 8601 extended format date time with microseconds
...
Serialized JSON array including the following attributes:
 ...
 - `expiration` - ISO 8601 extended format date time with microseconds
...
Response:
...

    {
        "metadata": Base64encode({
            ...
            "expiration": '2012-03-26T10:01:01.720000'
        }),
