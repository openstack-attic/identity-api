...
-  `matching_rule`
   ...
   Used in conjunction when `type` is `string`, a matching rule specifies
   how filter values will be matched for case sensitivity and in-exact
   comparison. Possible value are `case_sensitive` and `allow_partial_match`.
