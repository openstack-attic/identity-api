...
- Include `region_id` in service catalog in line with `region` deprecation from
  endpoint definition.
...
- `catalog` (list of object)
  ...
  - `region`: The geographic location of the service endpoint. **Deprecated in version 3.3**
  - `region_id`: The region identifier of the service endpoint. **New in version 3.3**
