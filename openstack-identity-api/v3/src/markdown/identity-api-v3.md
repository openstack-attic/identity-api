...
the `service`. The list of `roles` may be empty, no `domain` or `project` will
be included as the scope of authorization, and this response can be used to
uniquely identify a user. Example response:
