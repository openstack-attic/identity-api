...
These features are not yet considered stable (expected February 2014).
...
API, unless an exception these conventions is specifically documented. In
general, the Identity API provides an HTTP interface using JSON as the
transport format.
