...
- Extension Discovery.
- Publish list of revoked tokens
...
- *New in version 3.2* Retrieve a cryptographically signed list of non-expired tokens
  ids that have beenrevoked.  For long form tokens such as the CMS based PKI tokens,
  these will be the short form of the ID generated by a hash of the cryptographically
  signed token.

#### List revoked tokens: `GET /auth/tokens/revoked`
