...
* Note: The "child_regions" field shall be a list of region objects of
  the same form of the result of a call to `GET /regions/{region_id}` for
  the region's child regions. Grandchildren or further descendants are not
  returned.
