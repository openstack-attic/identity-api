...
Publish a Certificate Authority (CA) certificate and a signing certificate.
There are no parameters accepted in the request.
Both certificates are only returned in PEM format.
