...
oauth_token=aj9CovPUo44isTgs9F
    &oauth_token_secret=tCoZQiHWPMe8HMv5LFYPZvsMp3tkG5u_QM
    &oauth_expires_in=72000

Response Parameters:

- oauth_token: The Access Token that the Identity Service returns.
- oauth_token_secret: The secret associated with the Access Token.
- oauth_expires_in: The lifetime of the Access Token in seconds.
...
[Various Openstack token responses](https://github.com/openstack/identity-api/blob/master/openstack-identity-api/v3/src/markdown/identity-api-v3.md#authentication-responses)
