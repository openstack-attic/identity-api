...
### Add/Update public key for identity provider: `PUT /OS-IDP/identity_providers/{idp_id}/public-key`
...
### Get public key for an identity provider: `GET /OS-IDP/identity_providers/{idp_id}/public-key`
...
### Delete public key for identity provider: `DELETE /OS-IDP/identity_providers/{idp_id}/public-key
