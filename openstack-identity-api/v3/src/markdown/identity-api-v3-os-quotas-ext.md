...
2 types of quotas - per tenant quotas (project quota) and per user
quotas (user quota). They limit resources for concrete tenant and user
respectively.

What's New
-------------------------

- "Resource": some resource which can be limited (ram, number of cpu, etc)
- "Quota": describes some resource limitation. Can be characterized by
  subject for which this limit was set, type of resource and limit for this
  resource
