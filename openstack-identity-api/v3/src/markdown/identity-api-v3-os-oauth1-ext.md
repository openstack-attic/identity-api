...
- `secret` (string)
  ...
  A secret used by the Consumer to establish ownership of the `key`.  A
  consumer's `secret` is only returned once, during consumer creation.
...
### List user authorizations: `GET /users/{user_id}/OS-OAUTH1/authorizations`
...
Response:

    {
        "authorizations": [
            {
                ...
                "access_key": "6be26a",
                "links": {
                    "self": "http://identity:35357/v3/users/ce9e07/OS-OAUTH1/authorizations/6be26a"
                },
                "requested_roles": [
                    {
                        "id": "76e72a",
        ...
        "links": {
            "next": null,
            "previous": null,
            "self": "http://identity:35357/v3/users/ce9e07/OS-OAUTH1/authorizations"
        }
    }
...
### Delete user authorization: `DELETE /users/{user_id}/OS-OAUTH1/authorizations/{authorization_id}`
