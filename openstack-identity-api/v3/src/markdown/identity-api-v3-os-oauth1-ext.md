...
### List user authorizations: `GET /OS-OAUTH1/users/{user_id}/authorizations`
...
Response:

    {
        "authorizations": [
            {
                ...
                "access_key": "6be26a",
                "links": {
                    "self": "http://identity:35357/v3/OS-OAUTH1/authorizations/6be26a"
                },
                "requested_role_ids": [
                    {
                        "id": "76e72a",
        ...
        "links": {
            "next": null,
            "previous": null,
            "self": "http://identity:35357/v3/OS-OAUTH1/users/ce9e07/authorizations"
        }
    }
...
### Delete user authorization: `DELETE /OS-OAUTH1/users/{user_id}/authorizations/{authorization_id}`
