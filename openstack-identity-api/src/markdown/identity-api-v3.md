...
system will use the default domain/project associated with the user, again
with the most granular scope (i.e. project) being used if both a default
domain and project have been specified, or a 401 Not Authorized will be returned
if neither a default domain/project is not found or able to be used.   
