...
- `default_project_id` (string)
  ...
  *New in version 3.1* If the user does not have authorization the default
   project, it will be ignored at token creation.
...
*New in version 3.1* Additionally, if user's default project is invalid, a token will be issued without an explicit scope of authorization.
