...
- `expires_at` (string, ISO 8601 extended format date time with seconds)
...
- `issued_at` (string, ISO 8601 extended format date time with seconds)
...
Example entity:
    ...
    {
        "token": {
            "expires_at": "2013-02-27T18:30:00Z",
            "issued_at": "2013-02-27T16:30:00Z",
            "methods": [
                "password"
            ],
            "user": {
