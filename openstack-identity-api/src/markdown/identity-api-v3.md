...
*New in version 3.1* Additionally, if the caller specifies a `include-catalog` field set to `False` (in the authentication request body), the authentication response will not contain the services catalog.
