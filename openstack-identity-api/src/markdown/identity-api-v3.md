...
query_filter: group.id, role.id, scope.domain.id, scope.project.id, user.id (optional)
...
GET /role-assignments?user.id=MyUserID&scope.project.id=MyProjID&effective
