...
user-project or user-domain pair can have a unique set of roles assignments on
them.
...
assigning roles to the user on a project (including projects owned by other
domains).
