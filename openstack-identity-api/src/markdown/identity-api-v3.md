...
should contain all users with the effective role, including any by virtue of group
membership or the role inherited to projects from an owning domain.
...
Specifying `effective` in the query string of the url indicates that the returned list
should contain all effective roles for this user, including any by virtue of group
membership or roles inherited to projects from an owning domain.
...
Specifying `inherited` in the request indicates that this role should be inherited by all
projects that are owned by this domain.
...
Specifying `inherted` in the request indicates that this role should be inherited by all
projects that are owned by this domain.
...
If `inherited` is not specified in the query string of the url, then all user roles
assigned to this domain will be returned. If `inherited` is specified, then only
those roles marked as inherited will be returned.
...
If `inherited` is not specified in the query string of the url, then all group roles
assigned to this domain will be returned. If `inherited` is specified, then only
those roles marked as inherited will be returned.
