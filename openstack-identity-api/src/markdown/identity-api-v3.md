...
the token. It is accumulated. If example, if token was obtained by
"password_credentials" will contain "password_credentials". Later, the token
is rescoped, the new token will have both "password_credentials" and "token"
in the "auth_mechanisms".
