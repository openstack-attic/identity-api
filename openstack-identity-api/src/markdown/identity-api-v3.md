...
query_filter: domain.id, group.id, project.id, role.id, user.id (optional)
...
membership. Such a list will not include the group assigment entities themselves. If the
