...
- Issue unscoped token instead of denied access if user does not have
  authorization on the specified project or the default project is otherwise
  invalid
...
- `default_project_id` (string)
  ...
  project does not need to exist within the user's domain. If the user
  does not have authorization on the specified project or the default project
  is otherwise invalid, it will be ignored at token creation.
