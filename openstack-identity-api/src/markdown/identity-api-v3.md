...
Headers:
 ...
 - `X-Subject-Token`
   ...
   This header is used to convey the user token to be operated on for the
   Keystone token APIs. For token deletion, it is also used as the
...
Response:
    ...
    {
        "methods": ["password"],
        "extras": {--optional-key-value-pairs},
        "domain": {
            "enabled": true,
            "id": "...",
            "name": "..."
