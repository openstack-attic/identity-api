OpenStack Identity API v3 RH-TRUST Extension
============================================
...
#### Create trust: `POST /RH-TRUST/trusts`
...
Response:
...

    {
        "trust": {
            ...
            "impersonation": true,
            "links": {
                "self": "http://identity:35357/v3/RH-TRUST/trusts/1ff900"
            },
            "project_id": "ddef321",
            "roles": [
                {
            ...
            "roles_links": {
                "next": null,
                "previous": null,
                "self": "http://identity:35357/v3/RH-TRUST/trusts/1ff900/roles"
            },
            "trustee_user_id": "86c0d5",
            "trustor_user_id": "a0fdfd"
        }
...
#### List trusts: `GET /RH-TRUST/trusts`
...

    {
        "trusts": [
            ...
            },
            {
                ...
                "impersonation": true,
                "links": {
                    "self": "http://identity:35357/v3/RH-TRUST/trusts/f4513a"
                },
                "project_id": "0f1233",
                "trustee_user_id": "86c0d5",
...
Request:
    ...
    GET /RH-TRUST/trusts?trustor_user_id=a0fdfd
...
Request:
    ...
    GET /RH-TRUST/trusts?trustee_user_id=86c0d5
...

    {
        "trusts": [
            ...
            },
            {
                ...
                "impersonation": false,
                "links": {
                    "self": "http://identity:35357/v3/RH-TRUST/trusts/f45513a"
                },
                "project_id": "0f1233",
                "trustee_user_id": "86c0d5",
                "trustor_user_id": "3cd2ce"
...
#### Get trust: `GET /RH-TRUST/trusts/{trust_id}`
...
Response:
...

    {
        "trust": {
            ...
            "impersonation": true,
            "links": {
                "self": "http://identity:35357/v3/RH-TRUST/trusts/987fe8"
            },
            "roles": [
                {
                    "id": "ed7b78",
...
#### Delete trust: `DELETE /RH-TRUST/trusts/{trust_id}`

Response:

    Status: 204 No Content

#### List roles delegated by a trust: `GET /RH-TRUST/trusts/{trust_id}/roles`
...
#### Check if role is delegated by a trust: `GET /RH-TRUST/trusts/{trust_id}/roles/{role_id}`

Response:

    Status: 204 No Content

#### Get role delegated by a trust: `GET /RH-TRUST/trusts/{trust_id}/roles/{role_id}`
